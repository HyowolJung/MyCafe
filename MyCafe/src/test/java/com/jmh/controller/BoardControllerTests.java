...
@WebAppConfiguration
@ContextConfiguration(classes = {com.jmh.config.RootConfig.class, com.jmh.config.ServletConfig.class})
...
//		log.info(mockMvc.perform(MockMvcRequestBuilders.get("/board/get").param("bno", "4")).andReturn().getModelAndView().getModelMap());
//	} 
